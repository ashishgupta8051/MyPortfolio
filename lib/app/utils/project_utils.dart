...
List<ProjectUtils> projectUtils = [
  ...
  ProjectUtils(
    ...
    links: 'https://github.com/ashishgupta8051/',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/ashishgupta8051/elderly_exercise_app.git',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/ashishgupta8051/flutter_plant_app.git',
  ),
];
